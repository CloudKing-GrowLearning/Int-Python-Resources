...
#plt.title('Line chart of youth not in employment')
#plt.xlabel('Years')
#plt.ylabel('Percentage')
#plt.savefig(file_dir + '/line_example.pdf')

#hist
#female_series.plot(kind='hist')
#plt.title('Hist chart of youth not in employment')
#plt.xlabel('Years')
#plt.ylabel('Percentage')
#plt.savefig(file_dir + '/hist_example.pdf')
...
plt.xlabel('Years')
plt.ylabel('Percentage')
plt.savefig(file_dir + '/bar_example.png')